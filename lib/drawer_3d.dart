...
import 'image_sequence_animator_widget.dart';

class Drawer3D extends StatefulWidget {
  final Widget? child;

  const Drawer3D({Key? key, this.child}) : super(key: key);
    ...
    return Padding(
      ...
      child: InkWell(
        ...
        child: Text(
          ...
          style: TextStyle(
            fontSize: 25,
            color: active ? const Color(0xffbb0000) : Colors.black,
